...
while(1):
	...
	show_message(device, "Dogecoin $" + str (djson['dogecoin']['usd']), fill="white", font=proportional(LCD_FONT),scroll_delay = 0.04)
	show_message(device, "Uniswap $" + str (ujson['uniswap']['usd']), fill="white", font=proportional(LCD_FONT),scroll_delay = 0.04)
	show_message(device, "The Graph $" + str (gjson['the-graph']['usd']), fill="white", font=proportional(LCD_FONT),scroll_delay = 0.04)
	show_message(device, "NuCypher $" + str (njson['nucypher']['usd']), fill="white", font=proportional(LCD_FONT),scroll_delay = 0.04)
	show_message(device, "SafeMoon $" + str (sjson['safemoon']['usd']), fill="white", font=proportional(LCD_FONT),scroll_delay = 0.04)
